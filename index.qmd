...
$$ {#eq-number-hierarchy}
However, Mathjax is not LaTeX and only provides a subset of its features. This
leads to certain issues that need to be addressed (details in @sec-mathjax).

## Equations in Mathjax {#sec-mathjax}
